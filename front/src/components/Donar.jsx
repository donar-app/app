  ...
  return (
    <main className='tw-flex tw-flex-col tw-items-center tw-max-w-xs tw-mx-auto'>
      ...
      <form onSubmit={(e) => handleSubmit(e)} className='tw-space-y-4 tw-pt-4'>
        ...
        <input type='file' className='tw-appearance-none tw-shadow tw-w-full tw-border tw-text-gray-700 tw-py-2 tw-px-4 tw-rounded focus:tw-outline-none focus:tw-shadow-outline' />
