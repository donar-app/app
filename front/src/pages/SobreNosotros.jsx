        ...
        <div className='row'>
          <div className='col-lg-12 col-12 order-lg-2 order-2'>
            <div className='row text-center'>
              ...
              <div className='col-lg-4 col-12'>
                <div className='col-12 d-flex justify-content-center'>
                  <img src={Ariel} className='rounded-circle tw-wid' alt='Responsive image' width={130} />
                </div>
              ...
              <div className='col-lg-4 col-6'>
                <div className='col-12 d-flex justify-content-center'>
                  <img src={Emiliano} className='rounded-circle' alt='Responsive image' width={130} />
                </div>
                <div className='col-12 tw-pt-3'>
                  <p>Emiliano Rago</p>
                </div>
              ...
              <div className='col-lg-4 col-6'>
                <div className='col-12 d-flex justify-content-center'>
                  <img src={Ailu} className='rounded-circle' alt='Responsive image' width={130} />
                </div>
                <div className='col-12 tw-pt-3'>
            ...
            <div className='row my-4 text-center'>
              ...
              <div className='col-lg-4 col-6'>
                <div className='col-12 d-flex justify-content-center'>
                  <img src={Abbul} className='rounded-circle' alt='Responsive image' width={130} />
                </div>
                <div className='col-12 tw-pt-3'>
                  <p>Abbul Rodriguez</p>
                </div>
              ...
              <div className='col-lg-4 col-6'>
                <div className='col-12 d-flex justify-content-center'>
                  <img src={Maxi} className='rounded-circle' alt='Responsive image' width={130} />
                </div>
                <div className='col-12 tw-pt-3'>
              ...
              <div className='col-lg-4 col-12'>
                <div className='col-12 d-flex justify-content-center'>
                  <img src={Santiago} className='rounded-circle' alt='Responsive image' width={130} />
                </div>
                <div className='col-12 tw-pt-3'>
                  <p>Santiago Mena</p>
                </div>
            ...
            <div className='row'>
              ...
              <div className='col-12 d-flex justify-content-center'>
                <div className='col-lg-7 col-12 text-center'>
                  Donar, es una plataforma sin fines de lucro, donde las personas podrán dar o recibir donaciones de algún producto que pueda ser reutilizado u alimentos perecederos.
                  {' '}
                  <br />
