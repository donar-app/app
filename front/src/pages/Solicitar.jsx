...
const Solicitar = ({ authorization, setAuthorization }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    petition('publicaciones', 'POST', authorization.authorization, {
      titulo: document.querySelector('#solicitarRegister').value,
      ...
      {authorization && authorization.authorization ? (
        <>
          ...
          <form onSubmit={(e) => handleSubmit(e)} className='tw-space-y-4 tw-pt-4'>
            ...
            <textarea id='descriptionRegister' minLength='10' className='tw-resize-none tw-shadow tw-border tw-rounded focus:tw-outline-none focus:tw-shadow-outline tw-w-full tw-h-20 tw-p-2' placeholder='Descripcion del producto' />
